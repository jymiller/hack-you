...
function indeterminate(
  ...
  return {
    ...
    labels: { facts: bundle.provenance_label, recompute: "REAL", downstream_serve: "PRERUN" },
...
export function assess(
  ...
  return {
    ...
    watch: cls.watch,
    evidence,
    labels: { facts: bundle_facts_label(facts, obs), recompute: "REAL", downstream_serve: "PRERUN" },
...
function buildProposedWrite(
  ...
  return {
    ...
    rationale,
    evidence,
    downstream: { channel: "actionlayer", template: "reservation_of_rights", target_ref: `synthetic:${facts.borrower.borrower_id}`, dry_run: true },
