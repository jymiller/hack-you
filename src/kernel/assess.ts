...
function indeterminate(
  ...
  return {
    ...
    labels: { facts: bundle.provenance_label, recompute: "REAL", downstream_serve: "SYNTHETIC" },
...
export function assess(
  ...
  return {
    ...
    watch: cls.watch,
    evidence,
    labels: { facts: bundle_facts_label(facts, obs), recompute: "REAL", downstream_serve: "SYNTHETIC" },
